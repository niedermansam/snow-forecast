...
let clouds = L.tileLayer('http://{s}.tile.openweathermap.org/map/clouds/{z}/{x}/{y}.png?appid={apiKey}', {
	maxZoom: 19,
...
let wind = L.tileLayer('http://{s}.tile.openweathermap.org/map/wind_new/{z}/{x}/{y}.png?appid={apiKey}', {
	maxZoom: 19,
	attribution: 'Map data &copy; <a href="http://openweathermap.org">OpenWeatherMap</a>',
	apiKey: '5606fe6c8b895127844f35d6c3698fad',
	opacity: 1
...
let precip = L.tileLayer('http://{s}.tile.openweathermap.org/map/precipitation_new/{z}/{x}/{y}.png?appid={apiKey}', {
	maxZoom: 19,
	attribution: 'Map data &copy; <a href="http://openweathermap.org">OpenWeatherMap</a>',
	apiKey: '5606fe6c8b895127844f35d6c3698fad',
	opacity: .5
...
// Import base map
let basemap_0 = new L.tileLayer('https://server.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer/tile/{z}/{y}/{x}', {
	attribution: 'Tiles &copy; Esri &mdash; Esri, DeLorme, NAVTEQ, TomTom, Intermap, iPC, USGS, FAO, NPS, NRCAN, GeoBase, Kadaster NL, Ordnance Survey, Esri Japan, METI, Esri China (Hong Kong), and the GIS User Community'
});

let Esri_WorldStreetMap = new L.tileLayer('https://server.arcgisonline.com/ArcGIS/rest/services/World_Street_Map/MapServer/tile/{z}/{y}/{x}', {
...
let basemaps ={"Esri World Topo Map": basemap_0,
...
function resortPopups(feature, layer) {
    ...
    let popupContent = `<strong><a href='${feature.properties.url}' target='_blank'>${feature.properties.name}</a></strong>
...
let createMarkers  = new L.geoJson(resorts,{
    onEachFeature: resortPopups,
    pointToLayer: resortsLayer,
    popupAnchor: [0,0]
});
let resortsFeatureGroup= new L.featureGroup();
